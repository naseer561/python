...
# if year % 4 == 0 and (year % 100 != 0 or year % 400 == 0): # True and (True )
...
# python
# percentage = float(input("Enter the percentage score: "))  # 50
...
# # python
# char = input("Enter a character: ")                # R                                      #r  #1   @
...
# python
# side1 = float(input("Enter the length of side 1: "))            #10   10            3
# side2 = float(input("Enter the length of side 2: "))            #10    10           4
# side3 = float(input("Enter the length of side 3: "))            #10    20           5
